...
Copy the following base64 string, which represents the `Load Image.png` found in the `images` folder, and then paste it within the `URL` option of the Texture Viewer:
