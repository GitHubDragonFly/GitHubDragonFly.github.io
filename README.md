...
- Using Animated GIF as a texture is experimental and currently available only in OBJ Viewer and should be tried on simple models, see the animated GIF of a cube using Animated GIF as a texture in the `images` folder (it took some manipulation in order to present it as such)
- Tips:
