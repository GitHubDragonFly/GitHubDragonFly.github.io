...
- Using Animated GIF as a texture is experimental and currently available only in OBJ & PLY+STL viewers and should be tried on simple models, see the Animated GIF of a cube using Animated GIF as a texture in the `images` folder
- Tips:
