...
Notes about three.js viewers:
 ...
 - GLTF/GLB exporter seems to have a limitation, as reported [here](https://discourse.threejs.org/t/exporting-model-with-animations/6792), applicable to both DAE / FBX (as for FBX you could try using this [converter](https://github.com/facebookincubator/FBX2glTF) instead)
