( function () {
				...
				if ( object.isMesh ) {
					...
					if ( Array.isArray( object.material ) === true ) {
						...
						if ( ! material.isMeshStandardMaterial ) {
							...
							if ( color ) material.color.setRGB( color.r, color.g, color.b, THREE.LinearSRGBColorSpace );
						...
						if ( ! object.material.isMeshStandardMaterial ) {
							...
							if ( object.material.color ) {
								...
								material.color.setRGB( color.r, color.g, color.b, THREE.LinearSRGBColorSpace );
	...
	function buildMaterial( material, textures, quickLookCompatible = false ) {
		...
		function buildTexture( texture, mapType, color ) {
			...
			const id = texture.id + '_' + texture.flipY;
