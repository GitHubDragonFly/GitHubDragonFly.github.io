	...
	class LDrawLoader extends THREE.Loader {
		...
		constructor( manager ) {
			...
			this.setMaterials( [
				...
				this.parseColourMetaDirective( new LineParser( 'Trans_Purple CODE 52 VALUE #A5A5CB EDGE #280025 ALPHA 128' ) ),
				this.parseColourMetaDirective( new LineParser( 'Trans_Neon_Yellow CODE 54 VALUE #DAB000 EDGE #C3BA3F ALPHA 128' ) ),
				...
				this.parseColourMetaDirective( new LineParser( 'Rubber_Yellow CODE 65 VALUE #F5CD2F EDGE #333333 RUBBER' ) ),
				this.parseColourMetaDirective( new LineParser( 'Rubber_Trans_Yellow CODE 66 VALUE #CAB000 EDGE #8E7400 ALPHA 128 RUBBER' ) ),
				this.parseColourMetaDirective( new LineParser( 'Rubber_Trans_Clear CODE 67 VALUE #FFFFFF EDGE #C3C3C3 ALPHA 128 RUBBER' ) ),
				...
				this.parseColourMetaDirective( new LineParser( 'Speckle_Black_Copper CODE 75 VALUE #000000 EDGE #AB6038 MATERIAL SPECKLE VALUE #AB6038 FRACTION 0.4 MINSIZE 1 MAXSIZE 3' ) ),
				this.parseColourMetaDirective( new LineParser( 'Speckle_Dark_Bluish_Grey_Silver CODE 76 VALUE #635F61 EDGE #898788 MATERIAL SPECKLE VALUE #898788 FRACTION 0.4 MINSIZE 1 MAXSIZE 3' ) ),
				...
				this.parseColourMetaDirective( new LineParser( 'Milky_White CODE 79 VALUE #FFFFFF EDGE #C3C3C3 ALPHA 240' ) ),
				this.parseColourMetaDirective( new LineParser( 'Metallic_Silver CODE 80 VALUE #A5A9B4 EDGE #333333 METAL' ) ),
				this.parseColourMetaDirective( new LineParser( 'Metallic_Green CODE 81 VALUE #899B5F EDGE #333333 METAL' ) ),
				this.parseColourMetaDirective( new LineParser( 'Metallic_Gold CODE 82 VALUE #DBAC34 EDGE #333333 METAL' ) ),
				this.parseColourMetaDirective( new LineParser( 'Metallic_Black CODE 83 VALUE #1A2831 EDGE #333333 METAL' ) ),
				this.parseColourMetaDirective( new LineParser( 'Metallic_Dark_Grey CODE 87 VALUE #6D6E5C EDGE #333333 METAL' ) ),
				this.parseColourMetaDirective( new LineParser( 'Flat_Silver CODE 179 VALUE #898788 EDGE #333333 PEARLESCENT' ) ),
				this.parseColourMetaDirective( new LineParser( 'Metallic_Bright_Red CODE 184 VALUE #D60026 EDGE #333333 METAL' ) ),
				this.parseColourMetaDirective( new LineParser( 'Metallic_Dark_Green CODE 186 VALUE #008E3C EDGE #333333 METAL' ) ),
				this.parseColourMetaDirective( new LineParser( 'Rubber_Black CODE 256 VALUE #212121 EDGE #595959 RUBBER' ) ),
				this.parseColourMetaDirective( new LineParser( 'Dark_Blue CODE 272 VALUE #0D325B EDGE #1E1E1E' ) ),
				this.parseColourMetaDirective( new LineParser( 'Rubber_Blue CODE 273 VALUE #0033B2 EDGE #333333 RUBBER' ) ),
				this.parseColourMetaDirective( new LineParser( 'Pearl_Gold CODE 297 VALUE #CC9C2B EDGE #333333' ) ),
				this.parseColourMetaDirective( new LineParser( 'Metallic_Copper CODE 300 VALUE #C27F53 EDGE #333333 METAL' ) ),
				this.parseColourMetaDirective( new LineParser( 'Dark_Red CODE 320 VALUE #720E0F EDGE #333333' ) ),
				this.parseColourMetaDirective( new LineParser( 'Rubber_Red CODE 324 VALUE #C40026 EDGE #333333 RUBBER' ) ),
				this.parseColourMetaDirective( new LineParser( 'Rubber_Orange CODE 350 VALUE #D06610 EDGE #333333 RUBBER' ) ),
				this.parseColourMetaDirective( new LineParser( 'Rubber_Light_Grey CODE 375 VALUE #C1C2C1 EDGE #333333 RUBBER' ) ),
				this.parseColourMetaDirective( new LineParser( 'Rubber_Dark_Blue CODE 406 VALUE #001D68 EDGE #595959 RUBBER' ) ),
				this.parseColourMetaDirective( new LineParser( 'Rubber_Purple CODE 449 VALUE #81007B EDGE #333333 RUBBER' ) ),
				this.parseColourMetaDirective( new LineParser( 'Dark_Orange CODE 484 VALUE #A95500 EDGE #333333' ) ),
				this.parseColourMetaDirective( new LineParser( 'Rubber_Lime CODE 490 VALUE #D7F000 EDGE #333333 RUBBER' ) ),
				...
				this.parseColourMetaDirective( new LineParser( 'Rubber_Light_Bluish_Grey CODE 496 VALUE #A3A2A4 EDGE #333333 RUBBER' ) ),
				this.parseColourMetaDirective( new LineParser( 'Rubber_Flat_Silver CODE 504 VALUE #898788 EDGE #333333 RUBBER' ) ),
				this.parseColourMetaDirective( new LineParser( 'Rubber_White CODE 511 VALUE #FAFAFA EDGE #333333 RUBBER' ) )
			] );
