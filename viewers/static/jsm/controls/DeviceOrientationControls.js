...
const _q1 = new Quaternion( Math.sqrt( 0.5 ), 0, Math.sqrt( 0.5 ), Math.sqrt( 0.5 ) ); // - PI/2 around the x-axis
...
class DeviceOrientationControls extends EventDispatcher {
	...
	constructor( object ) {
		...
		this.disconnect = function () {
			...
			setObjectQuaternion( new Quaternion( - Math.sqrt( 0.5 ), 0, - Math.sqrt( 0.5 ), Math.sqrt( 0.5 ) ), 0, 0, 0, 0 );
